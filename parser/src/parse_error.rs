...
use crate::{
    convenience_types::{ParserInput, Span},
    Token,
};
...
impl<'a> chumsky::error::Error<'a, ParserInput<'a, 'static>> for ParseError {
    #[inline]
...
impl<'a> chumsky::label::LabelError<'a, ParserInput<'a, 'static>, Label> for ParseError {
    #[inline]
